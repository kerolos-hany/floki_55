...
int screenIndex;
List<Widget> outdoorMenuScreens = [
  McdonaldsSheratonOutdoorMenu(),
  McdonaldsAlShoroukOutdoorMenu(),
];
List<Widget> indoorMenuScreens = [
  McdonaldsSheratonIndoorMenu(),
  McdonaldsAlShoroukIndoorMenu(),
];
Map restaurantIndexer = {
  "McdonaldsSheraton": 0,
...
Map<String, WidgetBuilder> routes = {
  ...
  FirstScreen.route: (context) => HomeLayout(
        screenIndex: 0,
      ),
  QrCodeScanner.route: (context) => QrCodeScanner(),
  QrCodeErrorScreen.route: (context) => HomeLayout(
        screenIndex: 5,
      ),
  QrCodeCreator.route: (context) => QrCodeCreator(),
  HomeScreen.route: (context) => HomeLayout(
        screenIndex: 1,
      ),
  McdonaldsSheratonIndoorMenu.route: (context) => HomeLayout(
        screenIndex: 3,
        restaurantName: "Mcdonalds",
        branchName: "Sheraton",
      ),
  McdonaldsAlShoroukIndoorMenu.route: (context) => HomeLayout(
        screenIndex: 3,
        restaurantName: "Mcdonalds",
        branchName: "AlShorouk",
      ),
  McdonaldsSheratonOutdoorMenu.route: (context) => HomeLayout(
        screenIndex: 2,
        restaurantName: "Mcdonalds",
        branchName: "Sheraton",
      ),
  McdonaldsAlShoroukOutdoorMenu.route: (context) => HomeLayout(
        screenIndex: 2,
        restaurantName: "Mcdonalds",
        branchName: "AlShorouk",
      ),
  OutdoorCheckOut.route: (context) => HomeLayout(
        screenIndex: 6,
      ),
  IndoorCheckOut.route: (context) => HomeLayout(
        screenIndex: 7,
      ),
  PayByVisaScreen.route: (context) => HomeLayout(
        screenIndex: 8,
      ),
  PayByCash.route: (context) => HomeLayout(
        screenIndex: 9,
        selectedItems: [],
      ),
};
...
// Database
List<MenuItemModel> mcdonaldsAlShoroukMenuItems = [
  MenuItemModel(
  name: "Fries",
  price: 150,
  rate: 4.0,
...
List<MenuItemModel> mcdonaldsSheratonMenuItems = [
  MenuItemModel(
    name: "Salad",
    price: 50,
    rate: 4.5,
